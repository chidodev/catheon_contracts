...
contract CatheonLockedStaking is CatheonAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    function unstake(
        ...
        if (block.timestamp - info.mint_at > info.period) { 
